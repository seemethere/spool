...
Structured Spool fields are authoritative for gates and scheduling. Workpad Note Markdown can mirror or explain that state, but Spool will not parse Markdown checkboxes as the source of truth.
