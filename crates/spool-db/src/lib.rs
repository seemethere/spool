//! Spool persistence layer.
//!
//! The crate keeps the external `spool_db::...` API stable while organizing
//! persistence by Spool domain area so Worker Agents can inspect and edit a
