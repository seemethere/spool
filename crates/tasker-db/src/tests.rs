...
async fn persists_agent_run_metrics_for_pi_launcher_outcome() {
    ...
    assert_eq!(metrics.transcript_jsonl_event_count, Some(1));
    assert_eq!(metrics.tool_call_count, Some(20));
    ...
    assert_eq!(tool_counts.get("bash"), Some(&13));
